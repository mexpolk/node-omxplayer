...
function buildArgs(source, givenOutput, loop, initialVolume, showOsd, window) {
    let output = "";
    ...
    // Handle the window dimentions, if provided
    if (window) {
        args.push("--win", window);
    }
...
function Omx(source, output, loop, initialVolume, showOsd, window) {
    // ----- Local Vars ----- //
    ...
    function spawnPlayer(src, out, loop, initialVolume, showOsd, window) {
        let args = buildArgs(src, out, loop, initialVolume, showOsd, window);
